...
def run_svm_dataset(dataset_index, kernels):
    random.seed(42)
    ...
    for fig_num, kernel in enumerate(kernels):
        ...
        print('Correct cases/Total cases: %s/%s'
...
def mainExercise1(kernels, datasets):
    import pylab as pl
    ...
    for dataset in datasets:
        ...
        run_svm_dataset(dataset, kernels)   # data distribution 1
        print()
        print()
    #run_svm_dataset(2, kernels)   # data distribution 2
    #run_svm_dataset(3, kernels)   # data distribution 3
